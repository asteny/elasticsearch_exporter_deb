![build](https://github.com/asteny/elasticsearch_exporter-deb/actions/workflows/build.yml/badge.svg)

Elasticsearch_exporter deb
==========================

Deb package with [Elasticsearch_exporter](https://github.com/justwatchcom/elasticsearch_exporter) for Ubuntu (xenial, bionic, focal)
